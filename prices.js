...
// ── 시세 (매일 업데이트) ──────────────────────────
const 골드바_살때  = 720000;   // 손님이 살때 (우리 판매가) 1돈 기준
const 골드바_팔때  = 697000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 514000;   // 18K 손님이 팔때 원/돈
const K14          = 399000;   // 14K 손님이 팔때 원/돈
...
// ── 덩이금 매입가 (매일 업데이트) ───────────────────
const 덩이금_최고가 = 694000;  // GRADE 1 기준가 → 등급별 -10,000원 자동 계산

// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 687000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 685000;   // 검인 목걸이 · 팔찌 원/돈
const 열쇠가격        = '675~680'; // 열쇠 원/돈 (범위로 표시)
const 상패동물골프공  = '670~675'; // 상패 · 동물 · 골프공 원/돈
