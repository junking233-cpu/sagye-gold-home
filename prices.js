...
// ── 시세 (매일 업데이트) ──────────────────────────
const 골드바_살때  = 765000;   // 손님이 살때 (우리 판매가) 1돈 기준
const 골드바_팔때  = 733000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 542000;   // 18K 손님이 팔때 원/돈
const K14          = 420000;   // 14K 손님이 팔때 원/돈
const K10          = 185000;   // 10K 손님이 팔때 원/돈
const 백금         = 260000;   // 백금 손님이 팔때 원/돈
const 실버바_살때  = 3450000;  // 실버바 손님이 살때 1kg 99.9 기준
...
// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 720000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 715000;   // 검인 목걸이 · 팔찌 원/돈
const 열쇠가격        = '705~710'; // 열쇠 원/돈 (범위로 표시)
const 상패동물골프공  = '700~705'; // 상패 · 동물 · 골프공 원/돈

// ── 치금 (인레이/크라운 세분화) ──────────────────
const 치금_인레이     = 240000;   // 치금 인레이 원/돈
const 치금_크라운     = 140000;   // 치금 크라운 원/돈
