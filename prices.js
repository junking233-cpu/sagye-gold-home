...
// ── 덩이금 매입가 (매일 업데이트) ───────────────────
const 덩이금_최고가 = 720000;  // GRADE 1 기준가 → 등급별 -10,000원 자동 계산

// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 716000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 713000;   // 검인 목걸이 · 팔찌 원/돈
const 열쇠가격        = '700~710'; // 열쇠 원/돈 (범위로 표시)
