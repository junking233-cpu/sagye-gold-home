...
// ── 시세 (매일 업데이트) ──────────────────────────
const 골드바_살때  = 795000;   // 손님이 살때 (우리 판매가) 1돈 기준
const 골드바_팔때  = 762000;   // 손님이 팔때 (우리 매입가) 1돈 기준
...
const 실버바_팔때  = 3050000;  // 실버바 손님이 팔때 1kg 99.9 기준
...
const 검인목걸이팔찌  = 748000;   // 검인 목걸이 · 팔찌 원/돈
const 열쇠가격        = '740~745'; // 열쇠 원/돈 (범위로 표시)
const 상패동물골프공  = '735~740'; // 상패 · 동물 · 골프공 원/돈
