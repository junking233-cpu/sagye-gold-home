...
const 골드바_팔때  = 820000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 604000;   // 18K 손님이 팔때 원/돈
const K14          = 469000;   // 14K 손님이 팔때 원/돈
...
// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 805000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 800000;   // 검인 목걸이 · 팔찌 원/돈
