...
const 골드바_팔때  = 725000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 535000;   // 18K 손님이 팔때 원/돈
const K14          = 416000;   // 14K 손님이 팔때 원/돈
...
// ── 덩이금 매입가 (매일 업데이트) ───────────────────
const 덩이금_최고가 = 723000;  // GRADE 1 기준가 → 등급별 -10,000원 자동 계산

// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 717000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 715000;   // 검인 목걸이 · 팔찌 원/돈
const 열쇠가격        = '705~710'; // 열쇠 원/돈 (범위로 표시)
const 상패동물골프공  = '690~695'; // 상패 · 동물 · 골프공 원/돈
