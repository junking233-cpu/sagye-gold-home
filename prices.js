...
// ── 덩이금 매입가 (매일 업데이트) ───────────────────
const 덩이금_최고가 = 738000;  // GRADE 1 기준가 → 등급별 -10,000원 자동 계산

// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 732000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 730000;   // 검인 목걸이 · 팔찌 원/돈
const 열쇠가격        = '715~725'; // 열쇠 원/돈 (범위로 표시)
const 상패동물골프공  = '710~720'; // 상패 · 동물 · 골프공 원/돈
