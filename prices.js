...
const K10          = 246000;   // 10K 손님이 팔때 원/돈
const 백금         = 300000;   // 백금 손님이 팔때 원/돈
const 실버바_살때  = 4300000;  // 실버바 손님이 살때 1kg 99.9 기준
const 실버바_팔때  = 3600000;  // 실버바 손님이 팔때 1kg 99.9 기준

// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 820000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 810000;   // 검인 목걸이 · 팔찌 원/돈
const 열쇠가격        = '770~800'; // 열쇠 원/돈 (범위로 표시)
const 상패동물골프공  = '760~790'; // 상패 · 동물 · 골프공 원/돈
