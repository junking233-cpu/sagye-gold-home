...
// ── 시세 (매일 업데이트) ──────────────────────────
const 골드바_살때  = 810000;   // 손님이 살때 (우리 판매가) 1돈 기준
const 골드바_팔때  = 783000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 579000;   // 18K 손님이 팔때 원/돈
const K14          = 450000;   // 14K 손님이 팔때 원/돈
const K10          = 200000;   // 10K 손님이 팔때 원/돈
const 백금         = 290000;   // 백금 손님이 팔때 원/돈
const 실버바_살때  = 3950000;  // 실버바 손님이 살때 1kg 99.9 기준
const 실버바_팔때  = 3200000;  // 실버바 손님이 팔때 1kg 99.9 기준

// ── 덩이금 매입가 (매일 업데이트) ───────────────────
const 덩이금_최고가 = 780000;  // GRADE 1 기준가 → 등급별 -10,000원 자동 계산

// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 770000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 765000;   // 검인 목걸이 · 팔찌 원/돈
const 열쇠가격        = '750~755'; // 열쇠 원/돈 (범위로 표시)
const 상패동물골프공  = '745~750'; // 상패 · 동물 · 골프공 원/돈

// ── 치금 (인레이/크라운 세분화) ──────────────────
const 치금_인레이     = 285000;   // 치금 인레이 원/돈
const 치금_크라운     = 185000;   // 치금 크라운 원/돈
