...
const 골드바_팔때  = 816000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 601000;   // 18K 손님이 팔때 원/돈
const K14          = 466000;   // 14K 손님이 팔때 원/돈
...
// ── 덩이금 매입가 (매일 업데이트) ───────────────────
const 덩이금_최고가 = 810000;  // GRADE 1 기준가 → 등급별 -10,000원 자동 계산
...
// ── 치금 (인레이/크라운 세분화) ──────────────────
const 치금_인레이     = 312000;   // 치금 인레이 원/돈
const 치금_크라운     = 212000;   // 치금 크라운 원/돈
