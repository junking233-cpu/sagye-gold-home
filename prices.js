...
// ── 시세 (매일 업데이트) ──────────────────────────
const 골드바_살때  = 735000;   // 손님이 살때 (우리 판매가) 1돈 기준
const 골드바_팔때  = 712000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 526000;   // 18K 손님이 팔때 원/돈
const K14          = 408000;   // 14K 손님이 팔때 원/돈
const K10          = 180000;   // 10K 손님이 팔때 원/돈
const 백금         = 180000;   // 백금 손님이 팔때 원/돈
const 실버바_살때  = 3150000;  // 실버바 손님이 살때 1kg 99.9 기준
...
// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 703000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 700000;   // 검인 목걸이 · 팔찌 원/돈
