...
const 골드바_팔때  = 840000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 627000;   // 18K 손님이 팔때 원/돈
const K14          = 487000;   // 14K 손님이 팔때 원/돈
...
// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 835000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 830000;   // 검인 목걸이 · 팔찌 원/돈
const 열쇠가격        = '760~825'; // 열쇠 원/돈 (범위로 표시)
const 상패동물골프공  = '760~815'; // 상패 · 동물 · 골프공 원/돈
const 치금가격        = '38~53';   // 치금 원/g
