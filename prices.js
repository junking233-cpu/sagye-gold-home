...
const 골드바_팔때  = 755000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 558000;   // 18K 손님이 팔때 원/돈
const K14          = 433000;   // 14K 손님이 팔때 원/돈
const K10          = 200000;   // 10K 손님이 팔때 원/돈
const 백금         = 260000;   // 백금 손님이 팔때 원/돈
const 실버바_살때  = 3850000;  // 실버바 손님이 살때 1kg 99.9 기준
const 실버바_팔때  = 2900000;  // 실버바 손님이 팔때 1kg 99.9 기준

// ── 덩이금 매입가 (매일 업데이트) ───────────────────
const 덩이금_최고가 = 750000;  // GRADE 1 기준가 → 등급별 -10,000원 자동 계산
