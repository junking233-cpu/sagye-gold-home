...
const K18          = 555000;   // 18K 손님이 팔때 원/돈
const K14          = 427000;   // 14K 손님이 팔때 원/돈
...
// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 736000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 735000;   // 검인 목걸이 · 팔찌 원/돈
const 열쇠가격        = '710~725'; // 열쇠 원/돈 (범위로 표시)
const 상패동물골프공  = '705~720'; // 상패 · 동물 · 골프공 원/돈
