...
const 골드바_팔때  = 727000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 538000;   // 18K 손님이 팔때 원/돈
const K14          = 418000;   // 14K 손님이 팔때 원/돈
const K10          = 190000;   // 10K 손님이 팔때 원/돈
const 백금         = 200000;   // 백금 손님이 팔때 원/돈
const 실버바_살때  = 3400000;  // 실버바 손님이 살때 1kg 99.9 기준
const 실버바_팔때  = 2750000;  // 실버바 손님이 팔때 1kg 99.9 기준

// ── 덩이금 매입가 (매일 업데이트) ───────────────────
const 덩이금_최고가 = 724000;  // GRADE 1 기준가 → 등급별 -10,000원 자동 계산

// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 717000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 714000;   // 검인 목걸이 · 팔찌 원/돈
