...
const 골드바_팔때  = 738000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 546000;   // 18K 손님이 팔때 원/돈
const K14          = 424000;   // 14K 손님이 팔때 원/돈
...
// ── 덩이금 매입가 (매일 업데이트) ───────────────────
const 덩이금_최고가 = 736000;  // GRADE 1 기준가 → 등급별 -10,000원 자동 계산

// ── 개별 매입가 (필요시 수동 수정) ──────────────────
const 검인반지메달    = 730000;   // 검인 반지 · 회사메달 원/돈
const 검인목걸이팔찌  = 727000;   // 검인 목걸이 · 팔찌 원/돈
