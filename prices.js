...
// ── 시세 (매일 업데이트) ──────────────────────────
const 골드바_살때  = 835000;   // 손님이 살때 (우리 판매가) 1돈 기준
const 골드바_팔때  = 810000;   // 손님이 팔때 (우리 매입가) 1돈 기준
const K18          = 602000;   // 18K 손님이 팔때 원/돈
const K14          = 467000;   // 14K 손님이 팔때 원/돈
...
// ── 치금 (인레이/크라운 세분화) ──────────────────
const 치금_인레이     = 313000;   // 치금 인레이 원/돈
const 치금_크라운     = 213000;   // 치금 크라운 원/돈
