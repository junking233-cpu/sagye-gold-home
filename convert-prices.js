...
// ================================================
// GitHub Actions가 prices.js 변경을 감지하면
// 이 스크립트가 자동 실행되어 prices.json을 업데이트합니다.
// ================================================
...
function extractNumber(code, varName) {
  ...
  if (!match) {
    throw new Error(`변수를 찾을 수 없습니다: ${varName}`);
  }
...
const updated = kstDate.toISOString().split('T')[0]; // YYYY-MM-DD
